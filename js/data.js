...
const RECIPE_NUTRITION = {
  ...
  // ── Dinner ──
  'lemon-herb-chicken':            { cal: 480, protein: 28, fiber: 5  },
  'beef-bok-choy-stir-fry':        { cal: 520, protein: 38, fiber: 4  },
  'baked-salmon':                  { cal: 460, protein: 40, fiber: 7  },
  'gf-pasta-tomato':               { cal: 490, protein: 10, fiber: 6  },
  'chicken-fried-rice':            { cal: 460, protein: 38, fiber: 3  },
  'fish-tacos':                    { cal: 440, protein: 38, fiber: 7  },
  'chicken-curry':                 { cal: 420, protein: 38, fiber: 4  },
  'lamb-chops':                    { cal: 560, protein: 32, fiber: 6  },
  'pork-meatballs':                { cal: 620, protein: 38, fiber: 6  },
  'baked-potato-bar':              { cal: 500, protein: 21, fiber: 7  },
  'shrimp-pad-thai':               { cal: 520, protein: 35, fiber: 4  },
  'stuffed-bell-peppers':          { cal: 480, protein: 28, fiber: 5  },
  'turkey-bolognese':              { cal: 580, protein: 38, fiber: 5  },
  'one-pan-chicken-rice':          { cal: 520, protein: 35, fiber: 2  },
  'gf-mac-cheese':                 { cal: 560, protein: 24, fiber: 3  },
  'pork-tenderloin-roasted-veg':   { cal: 460, protein: 42, fiber: 5  },
  'turkey-burgers':                { cal: 450, protein: 33, fiber: 2  },
  'prawn-coconut-curry':           { cal: 440, protein: 36, fiber: 5  },
  'sheet-pan-sausage-veg':         { cal: 520, protein: 28, fiber: 6  },
  'maple-dijon-salmon':            { cal: 420, protein: 38, fiber: 1  },
  'maple-glazed-salmon':           { cal: 480, protein: 36, fiber: 2  },
  'turkey-burger':                 { cal: 450, protein: 28, fiber: 2  },
  'chicken-soup':                  { cal: 360, protein: 27, fiber: 3  },
  'shrimp-scampi':                 { cal: 520, protein: 42, fiber: 3  },
  'baked-cod':                     { cal: 420, protein: 34, fiber: 7  },
  'pork-carnitas-bowl':            { cal: 560, protein: 37, fiber: 1  },
  'beef-potato-pie':               { cal: 520, protein: 28, fiber: 6  },
  'tofu-stir-fry':                 { cal: 380, protein: 16, fiber: 4  },
  'lemon-garlic-shrimp-rice':      { cal: 430, protein: 40, fiber: 4  },
  'parmesan-crusted-chicken':      { cal: 560, protein: 48, fiber: 3  },
  'ginger-pork-rice':              { cal: 490, protein: 40, fiber: 3  },
  'roast-chicken-thighs-veg':      { cal: 540, protein: 40, fiber: 5  },
  'beef-pepper-stir-fry':          { cal: 500, protein: 35, fiber: 4  },
  'steak-chimichurri':             { cal: 620, protein: 48, fiber: 5  },
  'beef-tacos':                    { cal: 480, protein: 32, fiber: 5  },
  'chicken-quesadilla':            { cal: 520, protein: 42, fiber: 3  },
  'lemon-pepper-tilapia':          { cal: 420, protein: 42, fiber: 5  },
