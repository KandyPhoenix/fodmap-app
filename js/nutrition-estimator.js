...
(function () {
  ...
  const ING = [
    ...
    I('pumpkin(?: puree)?', 34, 1, 2.9, { cup: 245, can: 425 }),
    ...
    I('(?:cooked|leftover|day.?old|cold)[^,]{0,28}rice', 130, 2.7, 0.4, { cup: 158 }),
    I('(?:cooked|leftover)[^,]{0,28}(?:quinoa|barley|farro)', 120, 4.4, 2.8, { cup: 185 }),
    I('(?:cooked|leftover)[^,]{0,28}(?:pasta|noodles)', 158, 5.8, 1.8, { cup: 140 }),
    I('corn tortillas?', 218, 5.7, 6.3, { unit: 26 }),
    I('taco shells?', 475, 6, 6, { unit: 13 }),
    I('kimchi|sauerkraut|pickles?|guindilla|pickled [a-z]+', 20, 1, 1.5, { cup: 150, tbsp: 10 }),
    ...
    I('panko|bread ?crumbs', 395, 13, 3, { cup: 108 }),
    ...
    I('gf pasta|gluten.?free pasta|pasta|penne|spaghetti|macaroni|rotini|fettuccine|linguine|orzo|noodles?', 371, 13, 3, { cup: 105, oz: 28.35 }),
    I('tortillas?|wraps?', 310, 8, 4, { unit: 45 }),
    I('bread|sourdough|baguette', 265, 9, 2.7, { slice: 30 }),
    ...
    I('broccoli|tenderstem|broccolini', 34, 2.8, 2.6, { cup: 91 }),
    ...
    I('corn', 86, 3.3, 2, { cup: 145, can: 250, unit: 90 }),
    ...
    I('lettuce|romaine|arugula|greens|mixed greens', 17, 1.2, 2, { cup: 47 }),
    ...
    I('peanut butter|almond butter|nut butter', 588, 25, 6, { tbsp: 16 }),
    ...
    I('pumpkin seeds|pepitas|sunflower seeds|sesame seeds|seeds', 559, 30, 6, { tbsp: 10, cup: 129 }),
