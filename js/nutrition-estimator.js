...
(function () {
  ...
  const ING = [
    ...
    I('kimchi|sauerkraut|gherkins?|cornichons?|pickles?|guindilla|pickled [a-z]+', 20, 1, 1.5, { cup: 150, tbsp: 10, unit: 35 }),
    ...
    I('lettuce|romaine|arugula|rocket|watercress|greens|mixed greens', 17, 1.2, 2, { cup: 47 }),
