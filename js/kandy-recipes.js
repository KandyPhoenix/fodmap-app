...
const KANDY_RECIPES = [
...

  {
    ...
    ingredients: [
      { qty: '',          item: '── STARTER (build once, lives in fridge forever) ──' },
    ...
    steps: [
      'MAKE YOUR STARTER (5–7 days, 5 min/day): Day 1 — mix 1/3 cup flour + 3 tbsp water in a jar. Cover loosely. Leave at room temp.',
      'Days 2–7 — each day, discard half the starter, then feed with 1/3 cup flour + 3 tbsp water. It is ready when bubbly and doubles in size within 4–6 hours of a feeding.',
      'MAKE THE BREAD: Mix bread flour, warm water, salt, and 1/3 cup active starter until no dry flour remains. Rest 30 min.',
      'Do 4 stretch-and-folds, 30 min apart: grab one edge of the dough, pull it up and fold it over the top. Rotate the bowl and repeat 4 times. Takes 30 seconds each set.',
      ...
      'When ready to bake, place a Dutch oven (with lid) in the oven. Preheat to 500°F for 1 full hour.',
      'Flip the dough out onto parchment paper. Score the top with a sharp knife or razor — one confident slash across the middle.',
      'Carefully lower dough (on parchment) into the hot Dutch oven. Cover with lid. Bake 20 min.',
      'Remove lid. Reduce heat to 450°F. Bake 20 more min until deeply golden brown. Cool on a rack at least 1 hour before slicing.',
    ],
    fodmapNote: '⚠️ Max 2 slices per person. The overnight refrigerator fermentation is what makes this low FODMAP — the long cold rise breaks down most of the fructans in the flour. Do not skip it. Longer fridge time (up to 16 hours) = lower fructans. Store at room temp wrapped in a towel — not in plastic, which makes the crust go soft.',
    isCustom: true,
  },
