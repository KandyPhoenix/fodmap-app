...
const KANDY_RECIPES = [
...

  {
    ...
    ingredients: [
      ...
      { qty: '2 medium', item: 'potatoes, cubed into 1-inch pieces' },
    ...
    steps: [
      ...
      'Toss potato cubes with 1.5 tbsp olive oil, salt, and pepper. Spread on baking sheet.',
    ...
    fodmapNote: 'This meal is completely FODMAP-free. Potatoes and green beans are both safe. Make sure salmon is plain with no pre-added marinades or seasonings containing garlic or onion.',
    isCustom: true,
  },
...

  {
    ...
    steps: [
      ...
      'Build bowls: rice on bottom, then beef, corn, tomatoes, lettuce, and feta on top.',
    ],
    fodmapNote: 'Ground beef and cumin are safe. Keep corn to 1/2 cup per person. Feta contains some lactose — keep to about 2 tbsp per person. Cherry tomatoes and lettuce are FODMAP-free.',
    isCustom: true,
  },
...

  {
    ...
    ingredients: [
      ...
      { qty: '2 medium', item: 'carrots, peeled and cut into thin matchsticks' },
    ...
    fodmapNote: '⚠️ Use GREEN TOPS of scallions only — the white bulb end is high in fructans. Bok choy, carrots, ginger, and rice noodles are all FODMAP-safe. Use tamari (not regular soy sauce) if strictly gluten-free.',
    isCustom: true,
  },
...

  {
    ...
    ingredients: [
      ...
      { qty: '2 medium', item: 'zucchini, sliced into rounds' },
      { qty: 'to taste', item: 'salt and pepper' },
      { qty: '1 tbsp',   item: 'olive oil' },
    ],
    steps: [
      'Boil potato cubes in salted water 12–15 min until fork tender. Drain.',
      'Mash with warm lactose-free milk, 1 tbsp butter, salt and pepper. Keep warm.',
    ...
    fodmapNote: 'Potatoes and pork are FODMAP-free. Use lactose-free milk for the mash. Zucchini is low FODMAP at a moderate serving (1 medium per person). Season simply with salt and pepper — avoid garlic or onion powder.',
    isCustom: true,
  },
...

  {
    ...
    ingredients: [
      ...
      { qty: '1 medium', item: 'zucchini, sliced into half-moons' },
    ...
    fodmapNote: 'Shrimp, quinoa, and all vegetables here are low FODMAP. Red bell pepper is preferable to green (lower fructans). Zucchini is safe at this serving size. No garlic needed — lemon and olive oil do all the work.',
    isCustom: true,
  },
...

  {
    ...
    steps: [
      ...
      'Place sweet potato cubes on baking sheet, toss with 1 tbsp olive oil, salt and pepper.',
      ...
      'Add broccoli to pan, toss with remaining oil and season.',
      'Roast another 15 min until chicken is golden and reaches 165°F internal temp.',
      'Serve immediately.',
    ],
    fodmapNote: '⚠️ Sweet potato is limited to ½ cup cooked per person — do not exceed. Broccoli florets (not the stalk) are moderate FODMAP — keep to 3/4 cup per person. Chicken and lemon are FODMAP-free.',
    isCustom: true,
  },
...

  {
    ...
    ingredients: [
      ...
      { qty: '3 medium', item: 'carrots, peeled and cut into sticks' },
      { qty: '2 medium', item: 'potatoes, cut into wedges' },
      { qty: '3 tbsp',   item: 'olive oil, divided' },
      { qty: 'to taste', item: 'salt and pepper' },
    ...
    steps: [
      'Preheat oven to 425°F (220°C).',
      'Toss carrot sticks and potato wedges with 2 tbsp olive oil, salt and pepper. Spread on baking sheet.',
    ...
    fodmapNote: 'Steak, carrots, and potatoes are all completely FODMAP-free — a safe and satisfying end to the week. Season simply with salt and pepper only — avoid steak seasonings that contain garlic or onion powder.',
    isCustom: true,
  },
